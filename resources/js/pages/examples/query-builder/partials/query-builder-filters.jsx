...
export const queryBuilderFilterDefaults = {
    customers: [],
    companies: [],
    countries: [],
    agents: [],
...
export const deserializeQueryBuilderFilters = (filters = []) => ({
...
export const serializeQueryBuilderFilters = (draft) =>
    [
...
export const queryBuilderFilterGroups = ({
...
export default function QueryBuilderFilters({
    data,
    setData,
    selectedCustomerOptions = [],
    companyOptions = [],
    ...
    return (
        <FieldGroup className="gap-4">
            ...
            <Field className="gap-2">
                <FieldLabel htmlFor="query-placed-range">
                    Placed date range
                </FieldLabel>
                <DatePickerWithRange
                    htmlFor="query-placed-range"
                    numberOfMonths={1}
